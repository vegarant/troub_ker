% csl_op_fourier_wavelet_2d() is a function which perform as a two-dimensional Fourier
...
%
function y = csl_op_fourier_wavelet_2d(x, mode, N, idx, nres, wave_name);
